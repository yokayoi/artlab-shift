...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "支払額が少ない月はどうなりますか？",
        a: "ひと月の支払額が 3,000 円以下の場合は振込せず、翌月の支払いにまとめて繰り越されます。翌月の支払額に「先月の保留分」として加算されます。",
      },
      {
        q: "給与欄にいるピンクの吹き出しは何ですか？",
        a: "AI-SATO-β からの「ありがとう」メッセージです。毎月お疲れさまの気持ちを込めて、一人ひとりにメッセージを届けています。月によって内容が変わります。",
      },
    ],
  },
  {
